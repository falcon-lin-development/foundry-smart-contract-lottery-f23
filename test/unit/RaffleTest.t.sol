...
contract RaffleTest is Test {
    ...
    function testRaffleRecordsPlayerWhenTheyEnter() public {
        ...
        address playRecorded = raffle.getPlayer(0);
        assert(playRecorded == PLAYER);
    }
    ...
    function testCheckUpkeepReturnsFkaseIfIthasNoBalance() public {
        // arrange
        vm.warp(block.timestamp + interval + 1);
        vm.roll(block.number + 1);
    ...
    // testCheckUpkeepReturnsTrueWhenParams are good
        ...
        skipFork
    {
        ...
        // pretend to be chainlink vrf to get a winner
        VRFCoordinatorV2Mock(vrfCoordinator).fulfillRandomWords(
            uint256(requestId),
            address(raffle)
        );
